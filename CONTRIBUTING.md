# Contributing to Llama Cancer

Thank you for your interest in contributing to Llama Cancer! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to Llama Cancer:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llama-cancer.git
   cd llama-cancer
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llama-cancer.git
   ```
...
By contributing to Llama Cancer, you agree that your contributions will be licensed under the project's MIT License.
